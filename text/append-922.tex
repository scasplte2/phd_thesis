...
I also include, at the end, a letter we received from Sacher once they sent us the new PZTs.
	\begin{figure}
		\centerline{
		\includegraphics[height=0.75\textheight]{2017.02.06_Damaged PZT_TopView.jpg}}
		\caption{Damaged 922 master PZT}
	\end{figure}
	\begin{figure}
		\centerline{
		\includegraphics[width=\textwidth]{2017.02.28_Step1_RemovingTheCircuitBoard.jpg}}
		\caption{Removing the circuit board of the 922 master}
	\end{figure} 
	\begin{figure}
		\centerline{
		\includegraphics[height=0.75\textheight]{2017.02.28_Step2_ViewOfSpringTerminals.jpg}}
		\caption{Reference image of the spring terminal connections}
	\end{figure} 
	\begin{figure}
		\centerline{
		\includegraphics[height=0.75\textheight]{2017.02.28_NewlyInstalledPZT.jpg}}
