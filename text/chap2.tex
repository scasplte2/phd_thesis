...
Additionally, the PhD work of Simon Stellmer \hl{\cite{SimonStellmer2013}} and review of strontium quantum degenerate gases are also highly recommended reading \hl{\cite{StellmerRev2013}}.
...
% Intro
Experiments begin by cooling and trapping atomic strontium utilizing well-established atomic physics techniques \hl{\cite{Metcalf1999,Katori1999,Ido2000,Nagel2003,Mukaiyama2003a,Loftus2004,mmy09a,sth09a,Mickelson2010ja,Tey2010a,dym10a,stg10}}. 
...
For a thorough and detailed discussion of the relevant physics of trapping $^{87}$Sr, we refer the interested reader to the fermion portion of section 2.7.3 in the PhD thesis of Simon Stellmer \hl{\cite{SimonStellmer2013}} and section 2.2.1 of Pascal Mikelson's PhD thesis \hl{\cite{Mickelson2010b}}.

%\noindent \rule{75pt}{0.5pt} \newline
The trapping process begins with heating solid strontium in an oven to approximately 400 $^{\circ}$C. 
The resulting strontium vapor escapes through collimating tubes to produce a partially collimated beam with a mean velocity of $\sim$450\,m/s \hl{\cite{Mazurenko2010}}.
...
Upon entering the magnetic field of the Zeeman slower, the highest velocity atoms begin to scatter photons from the Zeeman beam, which is red detuned from the $^1S_0\,\rightarrow\,^3P_1$ transition by $\sim\!16\times$ the natural linewidth.
...
On average, an atom will fall into the $^3P_2$ state after scattering $\approx5\times10^4$ photons from the $^1S_0\,\rightarrow\,^1P_1$ transition \hl{\cite{Cooper2018}}.
...
Repumping from the $^3P_2$ state is achieved via a 481\,nm transition along the $(5s5p)\,^3P_2\,\rightarrow\,(5p^2)\,^3P2$ transition for approximately 50ms.
...
The end of the evaporation typically marks the beginning of the experimental phase and the divergence of the protocol into the specific procedures necessary. 
...
\caption{Sample trapping performance of $^{84}$Sr}{Each column shows the number of atoms and measured temperatures from time-of-flight (not applicable for the magnetic trap). The abbreviated column labels refer to the broadband (BB) and single frequency (SF) Red MOTs and ODT is the optical dipole trap.}
\label{tab:84perf}
\end{table}
...
Details on the original construction can be found in Refs.\,\hl{\cite{MartinezdeEscolar2010,Mickelson2010b}}. 
The master's of Francisco Camargo \hl{\cite{Camargo2015}} outlines the construction of the similar Rydberg apparatus. This more recent apparatus has benefited from the many lessons learned during the early life of the Neutral experiment.
...
The original drawings of these components can be found in App. A.10 of \hl{\cite{MartinezdeEscolar2010}} along with detailed information on the window coatings.
...
The task of redesigning the optical dipole traps was undertaken by Ying Huang and is detailed in her master's thesis \hl{\cite{Huang2013}}. 
...
As a point of clarification, Natali de Escobar's thesis\hl{\cite{MartinezdeEscolar2010}} presents two versions of the HV chamber in figures A.42 - A.47 while referencing that the original construction proceeded with version 1. 
...
Modeling and construction of this design was done by Anton Mazurenko, \hl{\cite{Mazurenko2010}}, with the goal of improving the angular discrimination of the oven assembly to produce a better collimated beam of atoms.
...
\caption{461\,nm systen AOM details}{Ind. column labels the AOMs as shown in Fig.\,\ref{fig:461blockSys}. The sign of the nominal frequency indicates the AOM order used.}
\label{tab:461AOM}
\end{table}
\end{landscape}
...
The use of magnetic tunability to control the 461\,nm light frequency is well documented in section 2.2.1 of Natali de Escobar's thesis \hl{\cite{MartinezdeEscolar2010}} and section 2.1.1 of Pascal Mikelson's thesis \hl{\cite{Mickelson2010b}}.
A more recent undergraduate project also explored optimizations of this scheme for the Rydberg apparatus \hl{\cite{MichaelViray2014}}.
...
Additional details on the original construction of the 922\,nm system can be found in App.\,A.8 of Natali de Escobar's thesis \hl{\cite{MartinezdeEscolar2010}}.
...
The original construction details are available in App A.8 of Natali de Escobar's thesis \hl{\cite{MartinezdeEscolar2010}}.
...
A detailed walkthrough of the construction and relevant physics of a blue saturated absorption cell can be found in the undergraduate report of Michael Viray \hl{\cite{MichaelViray2014}}.
...
Both beams have the short axis parallel to gravity to produce an oblate spheroid trapping volume which is useful for maintaining low density strontium-86 gases which reduces three-body recombination.
	\begin{figure} 
		...
		\caption{1064\,nm optical dipole trap schematic}{Paths for the loading and sheet traps are shown as they are realized on the apparatus. Also shown is the dimple trap path which is an optional configuration of the sheet trap \hl{\cite{Huang2013}}.}
...
Optical dipole traps result from the AC stark shift present whenever an atom interacts with a light field \hl{\cite{Grimm1999a}}.
...
This polarizability encapsulates the natural linewidth, detuning, and resonant behavior of the light field interaction with the bare atomic states \hl{\cite{Grimm1999a}}.
Sec.\,2.3.1 and App.\,A of Pascal Mikelson's PhD thesis \hl{\cite{Mickelson2010b}} outlines a calculation of the AC polarizability, which at 1064\,nm is $\frac{\alpha( \lambda = \text{1064\,nm} )}{2 \epsilon_0 c} = -10.9$\,Hz/(W/cm$^2$)\,$=-5.23\e{-8}$\,$\mu$K/(W/cm$^2$)\footnote{Units here are convenient lab units for quick calculation of trap parameters. Polarizability of $^1S_0$ in atomic units is $\alpha = 232.857$\,au.}  \hl{\cite{Ye2008}}.
...
The imaging relay system shown after the atomic sample was developed by Mi Yan and is outlined in detail in App. A of his PhD thesis \hl{\cite{Yan2013d}}. 
...
Fringes patterns are a well known nuisance in experimental AMO images and it has become routine to use linear algebra techniques (PCA, ICA, etc.) to create a composite background image for each atom image during analysis in order to create a higher quality image of the optical depth \hl{\cite{Segal2009}}.
...
It is based on the 2009 work of Appel et. al. \hl{\cite{zfr08expansion}} which outlines a versatile optical phase locked loop with a claimed frequency range of sub-MHz to 7\,GHz.
...
The original construction of the output optics is outlined in Ch.\,5 of Josh Hill's masters work \hl{\cite{Hill2017}} and is part of the layered optical systems added to the top of the optical chamber in 2017.
...
We account for and mitigate this instability by taking care to trigger all related processes from the same pulseblaster where the timing guarantees are more stringent and timing uncertainty is reduced to $50$\,ns \hl{ref pb manual}.
