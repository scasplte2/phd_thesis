...
Theoretically, this process is described by a pure $p=0$ plane wave, $\ket{\phi_{p=0}}$, suddenly loaded into an optical lattice and written as a superposition of the Bloch states given by Eq.\,\ref{eq:blochFunc}, here denoted by \ket{n,q}.
...
%The vertically propagating beam is also linearly polarized, however when propagating vertically, this polarization appears as a superposition of $\sigma+$ and $\sigma-$ vectors in the frame of the atoms.
...
% co-locating the trapping regions of the 532\,nm and 1064\,nm traps by
...
%When turning off the lattice and allowing the cloud to oscillate, identify the quarter-period time of the oscillation. 
...
%While Kapitza-Dirac diffraction is useful as a characterization tool, we typically wish to maintain equilibrium when loading condensates into the 
%In practice we find that our condensate fraction is reduced using ramps of this timescale into the lattice. 
%Instead, we more slowly ramp on the lattice over 100\,ms which reduces heating significantly 
