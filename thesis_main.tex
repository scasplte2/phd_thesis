...
\newcommand{\sqr}[1]{\ensuremath{\sqrt{ #1 }}} %texmaker auto-completes to sqrt{}{} so I want a custom command for fast typing
\newcommand{\Li}[3]{\ensuremath{\text{Li}_{\scriptscriptstyle\frac{#1}{#2}}\!\left[ #3 \right]}} %texmaker auto-completes to sqrt{}{} so I want a custom command for fast typing 
