...
hamilt.pot.handle      = @pot.spin_boson;% shifted harmonic osczillators
hamilt.pot.params.omega = 00.10;         % Harmonic frequency
hamilt.pot.params.gamma = 00.50;         % spin coupling
hamilt.pot.params.kappa = sqrt(0.05);    % asymmetry parameter
hamilt.pot.params.delta = 2*7.44;        % energy gap

% Initial wave function
psi.init.dof{1}.handle= @wav.gauss; % Gaussian-shaped wavepacket
psi.init.dof{1}.width = 2.236068;        % Width 
psi.init.dof{1}.pos_0 = -71.5;           % Center in position representation
psi.init.dof{1}.mom_0 =  00.0;           % Center in momentum representation
