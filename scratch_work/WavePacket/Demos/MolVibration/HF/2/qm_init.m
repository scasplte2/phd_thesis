...
time.main.stop  = 460;          % index of last time step
...
time.efield.ampli     = ones(4,1) * sqrt(1e12/3.5101e16);       % 1e13 W/cm^2
time.efield.delay     = [t0; T; t12+t0/10; t12+t0/5];             % delay times
...
time.efield.fwhm      = [0; t12-t0; t0/5; 0];                    % FWHM (/length) of pulses
