...
util.disp ( '***************************************************' )
util.disp ( 'Single crossing example, k=15(Tully 1990)' )
util.disp ( '***************************************************' )
...
time.main.stop  = 017;               % Index of final time step
...
hamilt.nip.params.min = -9;          % Beginning of inner grid region
hamilt.nip.params.max =  9;          % End of inner grid region
...
psi.init.dof{1}.mom_0 = 15.0;        % Center in momentum representation
...
plots.expect.energies.max = 0.06;
