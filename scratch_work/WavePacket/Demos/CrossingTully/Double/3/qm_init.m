...
util.disp ( '***************************************************' )
util.disp ( 'Dual crossing example, k=52 (Tully 1990)' )
util.disp ( '***************************************************' )
...
time.main.stop  = 023;               % Index of final time step
...
psi.init.dof{1}.mom_0 = 52.0;        % Center in momentum representation
...
if strcmp(plots.density.type, 'contour')
    ...
    plots.density.range.y_min = 40;
    plots.density.range.y_max = 60;
end

plots.expect.energies.max = 0.8;
