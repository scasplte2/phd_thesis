...
global atomic
frequencies = frequencies * atomic.wavenumber.PerCentiMeter;

% We are only interested in properties up to 1000 cm^-1, so remove everything
% outside a certain interval.
ftrafo(frequencies > 1050) = 0;
ftrafo(frequencies < 0) = 0;
frequencies(frequencies > 1050) = 1051;
...
global expect
format long
sort(expect.tot.tot*atomic.wavenumber.PerCentiMeter)
