...
obj.intern_kin = ifftshift(obj.kin, obj.dof);

% Just exponentiate...
obj.intern_kinexpo = exp(-i * time.sub.delta * fraction * obj.intern_kin);
...
obj.intern_factor = sqrt(obj.x_max - obj.x_min) / obj.n_pts ...
        * exp(-i * space.fbr.grid_ND{obj.dof} * obj.x_min);
