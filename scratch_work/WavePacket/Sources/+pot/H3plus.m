...
util.disp ('                                                   ')
util.disp ('***************************************************')
util.disp ( [ 'angular coordinate : ' num2str(hamilt.pot.params.c_dof) ] )
...
if ~strcmp(class(space.dof{hamilt.pot.params.c_dof}), 'grid_legendre')
