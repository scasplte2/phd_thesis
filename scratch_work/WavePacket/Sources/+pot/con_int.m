...
util.disp ('*************************************************')
util.disp ('                                                 ')
util.disp ( [ 'Force constant     omega : ' num2str(hamilt.pot.params.omega) ] )
util.disp ( [ 'Linear JT-coupling kappa : ' num2str(hamilt.pot.params.kappa) ] )
util.disp ( [ 'Quadr. JT-coupling gamma : ' num2str(hamilt.pot.params.gamma) ] )
util.disp ( ' ' )
...
eps1 = hamilt.pot.params.omega/2 * r2 + hamilt.pot.params.kappa * x;
eps2 = hamilt.pot.params.omega/2 * r2 - hamilt.pot.params.kappa * x;
beta  =                               + hamilt.pot.params.kappa * y;

eps1 = eps1 + hamilt.pot.params.gamma/2 * (x2-y2);
eps2 = eps2 - hamilt.pot.params.gamma/2 * (x2-y2);
beta = beta - hamilt.pot.params.gamma   * (x.*y);
