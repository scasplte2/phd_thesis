...
util.disp ('                                                       ')
util.disp ('*******************************************************')
util.disp ( [ 'Force constant A       : ' num2str(hamilt.pot.params.A) ] )
util.disp ( [ 'Cubic parameter lambda : ' num2str(hamilt.pot.params.L) ] )
util.disp ( [ 'Saddle height          : ' num2str(hamilt.pot.params.A^3/(6*hamilt.pot.params.L^2)) ] )
util.disp ( [ 'Radius of triangle     : ' num2str(hamilt.pot.params.A  /   hamilt.pot.params.L   ) ] )
