...
util.disp ('*****************************************************')
util.disp ( [ 'Charge parameter q_0: ' num2str(hamilt.dip.params.q_0) ] )
util.disp ( [ 'Length parameter r_0: ' num2str(hamilt.dip.params.r_0) ] )
...
hamilt.d_x.grid_ND{1,1} = hamilt.dip.params.q_0 * space.dvr.grid_ND{1}...
    .* exp ( - space.dvr.grid_ND{1}/hamilt.dip.params.r_0 );
