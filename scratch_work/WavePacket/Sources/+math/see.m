%------------------------------------------------------
%
% Calculate sine elliptic Mathieu functions of order r, 
...
function [c,eigenvalor,coef]=see(r,q,z)

% INPUT
%   r = 1,2,3,.. : integer order
...
if r<1
   util.error('Order must be real and positive')
end
