    ...
    % Surface plots of Wigner functions
        ...
        if expect.ind.pop{m}(step)>expect.min_pop
            ...
            if plots.density.marginals.on
                ...
                rho_pos = min( rho_pos/plots.dvr.rho_max, 1 );
                ...
                rho_mom = min( rho_mom/plots.fbr.rho_max*4, 1 );
