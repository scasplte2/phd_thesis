...
util.disp ( '*******************************************' )
util.disp ( 'Spin-boson system in 2 dimensions: diabatic' )
util.disp ( '*******************************************' )
...
% Propagator
time.propa.handle = @ket.cheby_real;     % Expansion in Chebyshev polynomials
time.propa.params.order     = 0;         % auto-determine order
time.propa.params.precision = 1e-10;     % required precision
...
hamilt.pot.params.omega= 03.0;           % Harmonic frequency
hamilt.pot.params.kappa= 06.0;           % Linear JT coupling
hamilt.pot.params.gamma= 00.0;           % Quadratic JT coupling
...
psi.init.dof{2}.width =  2.5;            % Width 
...
plots.density.surface.view  = [10 40];   % Perspective view (with potentials)
