...
hamilt.nip.params.min = [-12 -12];       % Beginning of inner grid region
hamilt.nip.params.max = [+12 +12];       % End of inner grid region
...
plots.density.type = 'contour';          % make a neat 3D plot
