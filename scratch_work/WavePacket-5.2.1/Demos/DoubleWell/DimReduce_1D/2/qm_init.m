...
time.efield.fwhm    = 50;                % Full width at half maximum
time.efield.ampli   = 3.75;              % u_0=3.75 [D/(e*a_0)] see section IV.C
time.efield.frequ   = 0.196;             % Omega = 0.196 [D/hbar], see section IV.C
time.efield.phase   = 9.8;               % Phase = frequ * delay = 0.196* 50 
...
control.lvne.relax.rate = 0.373779924;   % Gamma_{2->0} should be = 1 [D/hbar]
...
dim_red.balance.A_shift = 1e-6;          % Shift spectrum of matrix A
dim_red.balance.A_split = 1;             % dimension of instable part of A
dim_red.balance.BN_scale = 8;            % Scaling factor for control fields
...
dim_red.reduce.BN_scale = 4;             % Scaling factor for control fields
...
plots.expect.population.max =  0.8;
