...
hamilt.pot.params.c{1,1} = 1;        % Constant potential
hamilt.pot.params.v{2,2} = [0;2];    % Parabolic potential
hamilt.pot.params.c{1,2} = 0.1;      % Coupling (constant)
...
psi.init.dof{1}.pos_0 = -2.5;        % Center in position representation
