...
space.dof{1} = grid_fft;                 % Using FFT grid method
...
hamilt.truncate.max    = 75.0;           % Upper truncation of energy
...
plots.expect.energies.max = 20;          % Manual setting of range for energies
