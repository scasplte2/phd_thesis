...
hamilt.pot.handle         = @pot.retinal_2D;     % Hahn&Stock: Retinal potential
...
psi.init.dof{2}.width  = 1;              % Width 
psi.init.dof{2}.pos_0  = 0;              % Center in position representation
...
plots.density.surface.view = [32 32];    % View point for surface plot: [az el]

plots.density.type         = 'surface';

plots.expect.energies.max  = 0.15;
