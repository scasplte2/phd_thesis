...
time.main.delta  = 0.01*41.341;      % Size of time steps: 10 as 
time.sub.n   =   010;                % Number of sub steps per time step
...
time.efield.delay   = 0.25*41.341;   % Time delay of pulse center: 0.5 fs
time.efield.fwhm    = 0.25*41.341;   % Full width at half maximum: 0.5 fs
