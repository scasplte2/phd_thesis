...
util.disp ( '*********************************************' )
util.disp ( 'Tabulated potential (CT state of Cl-NH3)' )
...
plots.density.type = 'contour';          % Draw a 3D plot

plots.expect.energies.max = 0.15;        % Manually adjust the ranges of the energy plot
