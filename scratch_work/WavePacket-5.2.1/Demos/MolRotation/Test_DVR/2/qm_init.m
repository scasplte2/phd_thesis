...
hamilt.pot.params.d_e = [37244*conv_cm_au; 0];   % dissociation energy
hamilt.pot.params.r_e = [1.2746*conv_ang_au; 0]; % equilibrium length
hamilt.pot.params.alf = [2.38/(1.2746*conv_ang_au); 0];  % range parameter
hamilt.pot.params.t_e = 0;                       % energy shift
