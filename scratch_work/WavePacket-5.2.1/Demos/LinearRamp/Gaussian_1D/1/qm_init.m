...
hamilt.pot.params.v{1,1} = 1;            % Slope parameter

% Absorbing boundary conditions
hamilt.nip.handle      = @nip.power;     % No negative imaginary potential
hamilt.nip.params.exp  = 4;              % Exponent
hamilt.nip.params.min = -07;             % Beginning of inner-grid region
hamilt.nip.params.max =  15;             % End of inner-grid region

% Initial wave function
psi.init.dof{1}.handle= @wav.gauss; % Gaussian-shaped wavepacket
psi.init.dof{1}.width = +1.0;            % Width 
