...
hamilt.pot.handle      = @pot.tully3;% Single Crossing
hamilt.pot.params.A    = 0.0006;     % Tully's parameter A
hamilt.pot.params.B    = 0.10;       % Tully's parameter B
hamilt.pot.params.C    = 0.90;       % Tully's parameter C

% Absorbing boundary conditions
hamilt.nip.handle      = @nip.power; % Negative imaginary potential
hamilt.nip.params.exp  = 4;          % Exponent
hamilt.nip.params.min = -13;         % Beginning of inner grid region
hamilt.nip.params.max = +08;         % End of inner grid region
...
psi.init.dof{1}.mom_0 =  10.0;       % Center in momentum representation
