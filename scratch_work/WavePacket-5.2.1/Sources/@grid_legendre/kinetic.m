...
for m = 1:hamilt.coupling.n_eqs
    ...
    psi.dvr.new_ND{m} = obj.trafo_expand * psi.dvr.new_ND{m};

    % 2.
    psi.dvr.new_ND{m} = obj.kin .* psi.dvr.new_ND{m};

    % 3.
    psi.dvr.new_ND{m} = obj.trafo_reconstruct * psi.dvr.new_ND{m};
    psi.dvr.new_ND{m} = shape_back(obj, psi.dvr.new_ND{m}, permutation, shapedims);
end
