...
util.disp('              0    1 1                 2 2                ')
util.disp('**********************************************************')
util.disp([ 'Parameter A0 : ' num2str(hamilt.pot.params.a0) ])
util.disp([ 'Parameter A1 : ' num2str(hamilt.pot.params.a1) ])
util.disp([ 'Parameter A2 : ' num2str(hamilt.pot.params.a2) ])

if space.size.n_dim > 1 || ~strcmp(class(space.dof{1}), 'grid_legendre')
    util.err('This potential works only for one Legendre DOF')
end
...
hamilt.pot.grid_ND{1,1} = hamilt.pot.params.a0 + hamilt.pot.params.a1 * leg1 ...
                          + hamilt.pot.params.a2 * leg2;
