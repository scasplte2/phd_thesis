...
%
% Copyright (C) 2004-2016 Burkhard Schmidt
...
util.disp ( strcat('Version number :', num2str(info.version1),' (MATLAB)'))
util.disp ( strcat('Version number :', num2str(info.version2),' (work dir.)'))
util.disp ( ' ' )
util.disp ( ' (C) 2004-2016 Burkhard Schmidt, Ulf Lorenz, FU Berlin' )
...
util.disp ( strcat('MATLAB release :', info.release  ) )
