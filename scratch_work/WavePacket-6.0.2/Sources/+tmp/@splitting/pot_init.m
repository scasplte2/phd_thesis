...
if  ~hamilt.pot_couple
    % log.disp(['Initialize diagonal potential propagator for time step fraction: ', num2str(obj.frac)])
    for m=1:hamilt.coupling.n_eqs
    ...
    switch hamilt.coupling.n_eqs
        ...
        case 2
            % log.disp(['Initialize analytical potential coupling propagator for time step fraction: ', num2str(obj.frac)])
        ...
        otherwise
            ...
            % log.disp(['Initialize numerical potential coupling propagator for time step fraction: ', num2str(obj.frac)])
