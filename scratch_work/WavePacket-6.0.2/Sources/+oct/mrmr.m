...
log.disp ('Minima Realization and Model Reduction (MRMR)')
log.disp ('=============================================')
log.disp ('   ')
...
log.disp ([int2str(n_S) ' states are controllable and observable'])
% Sigma_2: controllable but not observable
log.disp ([int2str(n_P-n_S) ' states are controllable but not observable'])
