...
for  m=1:hamilt.coupling.n_eqs
    ...
    if obj.energy
        [~,h] = contour ( space.dvr{1} , ...
            -space.fbr{1}/2, ...
            hamilt.tef.wig{m}(:,:) );
        h.LevelList = linspace( obj.tef_min, obj.tef_max, obj.cnt_nlev );
