...
classdef surface < vis.densities & handle
    ...
    methods (Access = public)
        ...
        function obj = surface
            ...
            obj.col_map = 'default';     % Choice of Matlab's color maps
        ...
        function show_plot (obj, state, step)
            ...
            switch space.n_dim
                ...
                case 3
                    if isa (state,'traj')
                        log.error('Surface plot for trajectory data in 3-dim not yet implemented')
                    end
                    if obj.represent=='dvr'
                ...
                otherwise
                    log.error('Cannot draw a surface plot for more than 3 dimensions')
            end
