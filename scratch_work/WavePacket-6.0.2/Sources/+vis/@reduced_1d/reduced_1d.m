        ...
        function show_plot (obj, state, step)
                ...
                for m = 1:hamilt.coupling.n_eqs
                    ...
                    if expect.pop.cha{m}(step)>expect.min_pop
                        ...
                        switch space.n_dim
                            ...
                            otherwise
                                log.error ('Reduced density matrices only up to 5 dimensions')
                        end
            ...
            for k = 1:space.n_dim
                ...
                switch(lower(obj.represent))
                    ...
                    otherwise
                        log.error ('Choose either one of DVR or FBR or WIG or RRP representation')
                end
