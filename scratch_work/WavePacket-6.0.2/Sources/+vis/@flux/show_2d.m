...
for  m=1:hamilt.coupling.n_eqs
    ...
    if obj.energy
        ...
        h.LevelList = linspace( obj.pot_min, obj.pot_max, obj.cnt_nlev(2) );
    ...
    if expect.pop.cha{m}(step)>expect.min_pop
        ...
        switch(lower(class(state)))
            case ('traj')
                ...
                h.LevelList = linspace(cmin, cmax, 5);% obj.cnt_nlev(1) );
...
%         q.LineStyle = obj.patterns{1};
%         q.LineWidth = obj.l_thick;
%         q.Color     = obj.colors(m,:);
