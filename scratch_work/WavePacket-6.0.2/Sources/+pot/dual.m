...
classdef dual < pot.generic & handle
    
    properties (Access = public)
        
        A           % Constant potential
        B           % Prefactor of parabola
        C           % Constant coupling      
    ...
    methods (Access = public)
        ...
        function disp(obj)
            ...
            if obj.row==1 && obj.col==1
                log.disp ('Dual crossing example:  J. Chemical Physics 117, 11075 (2002)  ')
                log.disp ('***************************************************************')
                log.disp (' ')
                log.disp ( [ 'Constant potential    A : ' num2str(obj.A) ] )
                log.disp ( [ 'Prefactor of parabola B : ' num2str(obj.B) ] )
