...
for m = 1:hamilt.coupling.n_eqs
    ...
    if new
        [psi.new{m}, permutation, shapedims] = shape(obj, psi.new{m});
    else
        [psi.new{m}, permutation, shapedims] = shape(obj, psi.dvr{m});
    end
    ...
    psi.new{m} = shape_back(psi.new{m}, permutation, shapedims);
end
