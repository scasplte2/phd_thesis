...
classdef truncate < handle
    ...
    methods (Access=public)
        ...
        function disp (obj)
            ...
            log.disp ('***************************************************************')
            log.disp ('Initialize truncation of Hamiltonian     ')
            log.disp ('***************************************************************')
            log.disp (' ')
            log.disp ( [ 'Lower truncation of energies  : ' num2str(obj.e_min) ] )
            log.disp ( [ 'Upper truncation of energies  : ' num2str(obj.e_max) ] )
            log.disp ( [ 'Truncation range              : ' num2str(obj.delta) ] )
            log.disp ( ' ' )
        ...
        function trunc_pot_kin (obj)
            ...
            %% Output
            log.disp ('***************************************************************')
            log.disp ('Spectral range of Hamiltonian     ')
            log.disp ('***************************************************************')
            log.disp (' ')
            log.disp ( [ 'Maximum of kinetic energy     : ' num2str(hamilt.kin_max) ] )
            log.disp ( [ 'Minimum of potential energy   : ' num2str(hamilt.pot_min) ] )
            log.disp ( [ 'Maximum of potential energy   : ' num2str(hamilt.pot_max) ] )
            log.disp ( ' ' )
            log.disp ( [ 'Minimum of grid Hamiltonian   : ' num2str(hamilt.range.e_min) ] )
            log.disp ( [ 'Maximum of grid Hamiltonian   : ' num2str(hamilt.range.e_max) ] )
            log.disp ( [ 'Spectral range of Hamiltonian : ' num2str(hamilt.range.delta) ] )
            log.disp ( ' ' )
