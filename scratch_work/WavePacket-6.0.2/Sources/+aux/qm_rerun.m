...
log.disp (' ')
log.disp ('-------------------------------------------------------------')
log.disp (' Numerical solution of coupled time-dependent Schr�dinger    ')
log.disp (' equations using atomic units, i.e. hbar = m_e = e = 1       ')
...
log.disp ('                                                             ')
log.disp ('    d                 (        d    )                        ')
log.disp (' i -- psi( R, t ) = H ( R, -i --, t ) psi( R, t )            ')
log.disp ('   dt                 (       dR    )                        ')
log.disp ('                                                             ')
log.disp (' with psi(R,t)           Wavefunction      (vector, complex) ')
log.disp (' with H = T + V -iW -F*D Hamilton operator                   ')
log.disp (' with T = T(-i d/dR)     Kinetic energy    (scalar)          ')
log.disp (' with V = V(R)           Potential energy  (matrix)          ')
log.disp (' with W = W(R)           Negative imag. potential (scalar)   ')
log.disp (' with D = D(R)           Dipole moment     (matrix)          ')
log.disp (' with F = F(t)           Electrical field  (scalar, time-dep)')
log.disp ('                                                             ')
log.disp ('-------------------------------------------------------------')
log.disp (' ')
