...
log.disp ( '***************************************************************')
log.disp ( 'Dual crossing example :  Horenko, Weiser, Schmidt, Schuette    ')
log.disp ( '      see: The Journal of Chemical Physics, 120, 8913 (2004)   ')
log.disp ( '                                                               ')
log.disp ( '             ( A     C   )                                     ')
log.disp ( ' V_dia (R) = (           )                                     ')
log.disp ( '             ( C    BR^2 )                                     ')
log.disp ( '                                                               ')
log.disp ( 'with parameter values A=0.1, B=0.05, C=0.02                    ')
log.disp ( '                                                               ')
...
hamilt.coupling.represent  = 'adi';      % Adiabatic representation
hamilt.coupling.ini_rep    = 'adi';      % Adiabatic initial state
hamilt.coupling.ini_coeffs = [1 0];      % Initially only lower adiabatic state populated

% Spatial discretization
space.dof{1}      = grid.fft;            % Using FFT-based grid methods
