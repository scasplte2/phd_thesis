...
log.disp ( '***************************************************************')
log.disp ( 'Single crossing example: Horenko, Salzmann, Schmidt, Schuette  ')
log.disp ( '      see: The Journal of Chemical Physics, 117, 11075 (2002)  ')
log.disp ( '                                                               ')
log.disp ( '            ( A/R   C   )                                      ')
log.disp ( 'V_dia (R) = (           )                                      ')
log.disp ( '            ( C    BR^2 )                                      ')
log.disp ( '                                                               ')
log.disp ( 'with default values: A=1, B=1, C=0.1                           ')
log.disp ( '                                                               ')
...
space.dof{1}       = grid.fft;           % Using FFT based DVR/FBR scheme
