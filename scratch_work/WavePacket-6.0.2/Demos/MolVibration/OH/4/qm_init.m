...
time.steps.m_delta  = 2/atomic.t.fs;     % Size of time steps: 10 fs 
time.steps.m_start  = 000;               % Index of initial time step
time.steps.m_stop   = 1000;              % Index of final time step
time.steps.s_number = 20;                % Number of sub steps per time step
...
control.lvne.temperature = 0;            % Temperature in atomic units: 315,923.5 K
