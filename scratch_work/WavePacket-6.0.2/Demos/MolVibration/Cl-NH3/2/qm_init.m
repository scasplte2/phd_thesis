...
log.disp ( '*********************************************' )
log.disp ( 'Tabulated potential (CT state of Cl-NH3)' )
log.disp ( 'Physical Review Letters 93 (4), 048301 (2004)' )
log.disp ( '*********************************************' )
...
plots.expect.e_min = 0.00;               % Manually set energy range 
plots.expect.e_max = 0.10;               % Manually set energy range 
