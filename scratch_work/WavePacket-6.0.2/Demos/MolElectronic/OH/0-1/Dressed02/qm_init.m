...
log.disp ( '***************************************************************' )
log.disp ( 'Vibrationally state selective electronic          ' )
log.disp ( 'excitation of OH radical by a sin^2 pulse         ' )
log.disp ( '***************************************************************' )
log.disp ( '                                              ' )
log.disp ( 'Light pulse optimized to induce a transition  ' )
log.disp ( 'from the electronic *and* vibrational         ' )
log.disp ( 'molecular ground state X2Pi(v=0)              ' )
log.disp ( 'to an electronically *and* vibrationally      ' )
log.disp ( 'molecular excited state A2Sigma+ (v=1)        ' )
log.disp ( '                                              ' )
log.disp ( 'Using 2 dressed states to demonstrate         ' )
log.disp ( 'predominance of 1-photon transition           ' )
log.disp ( '                                              ' )
log.disp ( 'see M.V.Korolkov, G.K.Paramonov               ' )
log.disp ( 'Phys. Rev. A 57(6), 4998  (1998), Fig. 2a+b   ' )
log.disp ( '**********************************************' )
...
% Electric field using (Floquet) dressed states
