...
log.disp ( 'of the planar quantum pendulum' )
log.disp ( 'B. Schmidt and B. Friedrich' )
log.disp ( 'Front. Phys. 2, 37' )
log.disp ( 'DOI:10.3389/fphy.2014.00037' )
log.disp ( 'Reproducing red circles in Fig. 4' )
log.disp ( 'USING HERE: FFT-DVR for THETA' )
log.disp ( '***************************************' )
...
% Potential: beta=5, kappa=3
hamilt.pot{1,1} = pot.pendulum;          % Potential for generalized pendula
hamilt.pot{1,1}.eta  = 15;               % Orientation: cos
