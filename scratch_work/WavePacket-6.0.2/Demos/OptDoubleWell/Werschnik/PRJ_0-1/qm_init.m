function qm_init
global hamilt space plots time control 

log.disp ( '***********************************' )
log.disp ( 'Optimally driven double-well system' )
log.disp ( '                                   ' )
log.disp ( 'see J. Werschnik and E. K. U. Gross' )
log.disp ( 'J. Phys. B 40, R175  (2007)        ' )
log.disp ( 'doi:10.1088/0953-4075/40/18/R01    ' )
log.disp ( '***********************************' )
