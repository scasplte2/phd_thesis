...
log.disp ( '***************************************************************' )
log.disp ( 'Benchmark: Coherent state of a harmonic oscillator, N dimensions' )
log.disp ( '***************************************************************' )

% Spatial discretization
for i_dim=1:n_dim
    space.dof{i_dim} = grid.fft;         % Using FFT grid method
...
% Propagator
time.propa       = tmp.cheby_real;        % Split operator method
time.propa.order = 0;                    % Strang splitting
