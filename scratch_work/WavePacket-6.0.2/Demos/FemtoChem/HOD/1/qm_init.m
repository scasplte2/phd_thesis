...
log.disp ('********************************')
log.disp ('Bond breakage of HOD            ')
log.disp ('with an unshaped laser pulse.   ')
log.disp ('see PhysRev A 78:065402 (2008)  ')
log.disp ('********************************')
...
time.steps.s_number = 20;                % propagation time step 1 a.u.
...
time.pulse{1}       = efi.sin_2;         % sin^2 shape
time.pulse{1}.fwhm  = 25/atomic.t.fs;    % 25 fs  FWHM
time.pulse{1}.delay = 25/atomic.t.fs;    % centered around t = 25 fs
time.pulse{1}.ampli = sqrt(18/atomic.I.TW_cm2);  
time.pulse{1}.frequ = 0.27;              % frequency
