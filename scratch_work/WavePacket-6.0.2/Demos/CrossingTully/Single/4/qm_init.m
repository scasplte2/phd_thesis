...
log.disp ( '****************************************************************' )
log.disp ( 'Single crossing example, k=15(Tully 1990)' )
log.disp ( '****************************************************************' )
...
time.steps.m_stop   = 017;               % Index of final time step
...
hamilt.nip{1}.min = -9.0;                % Beginning of inner grid region
hamilt.nip{1}.max = +9.0;                % End of inner grid region
hamilt.nip{2} = nip.power;               % Negative imaginary potential
hamilt.nip{2}.exp = 4;                   % Exponent
hamilt.nip{2}.min = -9.0;                % Beginning of inner grid region
hamilt.nip{2}.max = +9.0;                % End of inner grid region
...
time.dof{1}.mom_0 = 15.0;                % Center in momentum representation
...
plots.density.pot_max = 0.02;

% Plot expectation values
plots.expect       = vis.expect;
plots.expect.e_max = 0.06;
