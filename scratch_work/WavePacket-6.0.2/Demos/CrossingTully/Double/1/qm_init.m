...
log.disp ( '****************************************************************' )
log.disp ( 'Dual crossing example, k=13 (Tully 1990)' )
log.disp ( '****************************************************************' )
...
hamilt.truncate.e_max =  0.30;           % Upper truncation of energy
...
time.dof{1}.mom_0 = 13.0;                % Center in momentum representation
