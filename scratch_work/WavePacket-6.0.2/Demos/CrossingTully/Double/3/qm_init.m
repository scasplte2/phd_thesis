...
log.disp ( '****************************************************************' )
log.disp ( 'Dual crossing example, k=52 (Tully 1990)' )
log.disp ( '****************************************************************' )
...
time.steps.m_stop   = 023;               % Index of final time step
...
hamilt.pot{1,1} = pot.tully2;            % Double Crossing
hamilt.pot{2,2} = pot.tully2;            % Double Crossing
hamilt.pot{1,2} = pot.tully2;            % Double Crossing
...
time.dof{1}.mom_0 = 52.0;                % Center in momentum representation
...
plots.density.y_min = 40;
plots.density.y_max = 60;

% Plot expectation values
plots.expect       = vis.expect;
plots.expect.e_max = 0.8;
