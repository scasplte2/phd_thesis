...
log.disp ( '********************************************************************' )
log.disp ( 'Free particle with zero momentum: Wavepacket dispersion' )
log.disp ( '********************************************************************' )
...
hamilt.nip{1}.min = [-12 -12];           % Beginning of inner grid region
hamilt.nip{1}.max = [+12 +12];           % End of inner grid region
