...
log.disp ( '********************************************************************' )
log.disp ( 'Collinear model for the reaction F+D2 -> DF + D        ' )
log.disp ( 'see also Whitlock, Muckerman, JCP 61:4618 (1974) and   ' )
log.disp ( 'Muckerman, JCP 54:1155 (1971)                          ' )
log.disp ( '                                                       ' )
log.disp ( 'LEPS surface taken from Steinfeld, Francisco, Hase     ' )
log.disp ( '"Chemical Kinetics and Dynamics" p. 245, problem 7.14  ' )
log.disp ( '                                                       ' )
log.disp ( 'Low collision energy                                   ' )
log.disp ( '********************************************************************' )
...
hamilt.truncate.e_min= -0.25;            % lower truncation of energy
hamilt.truncate.e_max=  0;               % upper truncation of energy
