...
log.disp ( '******************************************' )
log.disp ( 'Generic E x e conical intersection with   ' )
log.disp ( 'linear and quadratic Jahn-Teller coupling:' )
log.disp ( 'Dynamics on warped, lower state only' )
log.disp ( 'Localized wavepacket with k=5' )
log.disp ( '******************************************' )
...
time.dof{1}.mom_0 =  5 * cos(0.60*pi);   % Center in momentum representation
...
time.dof{2}.mom_0 =  5 * sin(0.60*pi);   % Center in momentum representation
...
plots.expect.e_max      = 15;            % manual setting of upper energy bond
