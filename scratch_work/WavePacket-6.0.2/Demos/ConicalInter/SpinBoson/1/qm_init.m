...
log.disp ( '*******************************************' )
log.disp ( 'Spin-boson system in 2 dimensions: diabatic' )
log.disp ( '*******************************************' )
...
% Propagator
time.propa           = tmp.cheby_real;   % Expansion in Chebyshev polynomials
...
% plots.density.srf_view = [10 40];        % Perspective view (with potentials)
