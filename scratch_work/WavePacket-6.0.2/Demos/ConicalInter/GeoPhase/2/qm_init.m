...
log.disp ( 'with linear Jahn-Teller coupling included:' )
log.disp ( 'Dynamics on lower (Mexican hat) state only' )
log.disp ( 'Neglecting geometric (Berry) phase effect!' )
log.disp ( '******************************************' )
...
% Propagator
time.propa = tmp.splitting;              % Splitting method
