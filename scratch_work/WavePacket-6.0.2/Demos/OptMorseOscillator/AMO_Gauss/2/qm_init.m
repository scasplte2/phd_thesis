...
log.disp ( '*****************************************************************' )
log.disp ( 'Optimal control of a bond length for a model Morse  ' )
log.disp ( 'oscillator resembling one of the OH bonds in water  ' )
log.disp ( '                                                    ' )
log.disp ( 'see Figs. 1-4 of: W. Zhu and H. Rabitz              ' )
log.disp ( 'J. Chem. Phys. 109(2), 385-391  (1998)              ' )
log.disp ( 'http://dx.doi.org/10.1063/1.476575                  ' )
log.disp ( '*****************************************************************' )
...
time.pulse{1}.file   = 'tdse_optimal_30.dat';   % file to load the field from
