...
time.pulse{1}.fwhm   = 1000/atomic.t.fs; % Pulse length
...
control.observe.types = 'ovl';           % types of observables
...
control.relax.model = 'omega';           % Relaxation model
control.relax.rate  = 3.705e-5;          % Relaxation rate (inverse of 1/e time)
